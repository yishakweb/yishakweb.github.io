...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2026 at 07:15 PM
...
('root', '[{\"db\":\"school\",\"table\":\"teach_table\"},{\"db\":\"school\",\"table\":\"login\"}]');
...
('root', '2026-02-27 18:11:57', '{\"Console\\/Mode\":\"collapse\"}');
...
INSERT INTO `course_table` (`co_id`, `co_name`, `department`) VALUES
...
CREATE TABLE `room_table` (
  ...
  `bld_num` varchar(10) DEFAULT NULL,
...
INSERT INTO `room_table` (`room_id`, `bld_num`, `room_type`) VALUES
('Ro2', 'B001', 'Lab'),
('Ro3', 'B003', 'Lecture'),
('Ro4', 'B002', 'Lecture'),
('Ro5', 'B001', 'Lab');
